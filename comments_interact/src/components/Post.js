...
export default function Post({com}) {
    ...
    return (
        <div className="card">
            ...
            <div className="card-header">
                <div className="img-user"><img src={ com.user.image } alt="" /></div>
                <h2 className="user-name">AmyRobson</h2>
                <span className="created-date">1 month ago</span>
            ...
            <p className="comments">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat autem corporis, itaque quisquam animi maiores quod earum voluptas magnam nostrum ipsam, dolore, excepturi sunt quia minima! Veritatis quidem ab sequi maiores vel architecto minima vero. Unde animi provident voluptas incidunt! Consectetur, hic deleniti. Quam omnis quaerat soluta voluptates sapiente, ea, atque quo incidunt quibusdam at eius blanditiis recusandae tempora veritatis.</p>
            </div>
            <div className="note">
