...
export default function Replies() {
    return (
        <>
        {
            commentsData?.map((replies) => (
                ...
                <div className="content">
            			<div className="card-header">
                			<div className="img-user"><img src={ replies.user.image.png } alt="" /></div>
                				<h2 className="user-name">{ replies.username }</h2>
                				<span className="created-date">{ replies.createdAt }</span>
            ...
            <p className="comments">{ replies.content }</p>
            </div>
			...
			<div className="votes-counter">{replies.score}</div>
